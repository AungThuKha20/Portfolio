...
const Home = () => {
    return (
        <div className=" pt-10 px-[1%] !select-none bg-gray-950">
            ...
            <div className=" text-center font-semibold leading-tight text-9xl font-sans center flex justify-center gap-8"><h1>AUNG THU KHA</h1></div>
            <figure className="mt-20 relative z-10 mx-auto w-full aspect-video">
                <div className="w-full h-full relative">
                    <img
                        ...
                        alt=""
                        style={{
                            maskImage: 'linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,0.8) 20%)',
                            WebkitMaskImage: 'linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,0.8) 20%)'
                        }}
                    />
